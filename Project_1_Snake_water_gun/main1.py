...
'''
here is huge problem that computer always choses -1 , so we get only limited and same results , as we have 
defines what computer has choen
But this game will become interesting when - computer will choose a random guess and we will make a random guess

'''

#There is random module in python which helps to choose any random number
